...
const {hashPassword} = require("../middleware");//import encrypted object/password & jwtoken functions
...
//Note: createUser is only n here as a temp AbortController. It will be replaced
